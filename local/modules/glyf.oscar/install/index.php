 ...
 */
class glyf_oscar extends CModule
{
    // Настройки модуля.
    var $MODULE_ID              = 'glyf.osca'; // Без var не пускает в маркетплейс.
     ...
     */
    public function glyf_oscar()
    {
        global $APPLICATION, $DOCUMENT_ROOT;
        
        $this->MODULE_NAME           = GetMessage('GLYF_OSCAR_MODULE_NAME');
        $this->MODULE_DESCRIPTION    = GetMessage('GLYF_OSCAR_MODULE_DESC');
    ...
    public function DoInstall()
    {
        ...
        switch ($this->step) {
            ...
            case 'index':
				...
				// $APPLICATION->IncludeAdminFile(GetMessage('GLYF_OSCAR_MODULE_INSTALL_STEP_INDEX'), $DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/install/steps/install/' . $this->step . '.php');
                break; 
            
			// Завершение установки.
            case 'finish':
                // include ($DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/steps/install/' . $step . '-save.php');
                // $APPLICATION->IncludeAdminFile(GetMessage('GLYF_OSCAR_MODULE_INSTALL_STEP_FINISH'), $DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/install/steps/install/' . $this->step . '.php');
                break;
    ...
    public function DoUninstall()
    {
        ...
        switch ($this->step) {
            ...
            case 'index':
                ...
                // $APPLICATION->IncludeAdminFile(GetMessage('GLYF_OSCAR_MODULE_UNINSTALL_STEP_INDEX'), $DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/install/steps/uninstall/' . $this->step . '.php');
                break; 
            
			// Завершение установки.
            case 'finish':
                // include ($DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/steps/uninstall/' . $step . '-save.php');
                // $APPLICATION->IncludeAdminFile(GetMessage('GLYF_OSCAR_MODULE_UNINSTALL_STEP_FINISH'), $DOCUMENT_ROOT . $this->MODULE_PATH . $this->MODULE_ID . '/install/steps/uninstall/' . $this->step . '.php');
                break;
